...
import {
    getDeliveryMethods,
    getOrdersCartForUser,
} from "./helpers/useEffectHelper.js";
...
export function Checkout(props) {
    ...
    const payments = ["Przelewy24", "Blik", "fasd"];
    ...
    useEffect(() => {
        let price = ordersCart.reduce((accumulator, currentValue) => {
            ...
            return (
                accumulator + Number(orderItem.quantity) * Number(product.price)
            );
        }, 0);
                ...
                <form onSubmit={onSubmitPay}>
                    ...
                    <div className="col-12">
                        ...
                        <select
                            className="form-control"
                            onChange={(event) =>
                                handleInputChange(event, setPaymentMethod)
                            }
                            value={paymentMethod}
                        >
